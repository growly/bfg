...
PROTOBUF_CONSTEXPR SimOptions::SimOptions(
  ...
  , /*decltype(_impl_.tnom_)*/0
  , /*decltype(_impl_.gmin_)*/0
  , /*decltype(_impl_.iabstol_)*/0
  , /*decltype(_impl_.reltol_)*/0
  , /*decltype(_impl_._cached_size_)*/{}} {}
...
static ::_pb::Metadata file_level_metadata_spice_2eproto[34];
...
const uint32_t TableStruct_spice_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::vlsir::spice::SimOptions, _impl_.temp_),
  PROTOBUF_FIELD_OFFSET(::vlsir::spice::SimOptions, _impl_.tnom_),
  PROTOBUF_FIELD_OFFSET(::vlsir::spice::SimOptions, _impl_.gmin_),
  PROTOBUF_FIELD_OFFSET(::vlsir::spice::SimOptions, _impl_.iabstol_),
  PROTOBUF_FIELD_OFFSET(::vlsir::spice::SimOptions, _impl_.reltol_),
  ~0u,  // no _has_bits_
...
const ::_pbi::DescriptorTable descriptor_table_spice_2eproto = {
    false, false, 3901, descriptor_table_protodef_spice_2eproto,
    "spice.proto",
...
SimOptions::SimOptions(const SimOptions& from)
  ...
  new (&_impl_) Impl_{
    ...
    , decltype(_impl_.tnom_){}
    , decltype(_impl_.gmin_){}
    , decltype(_impl_.iabstol_){}
    , decltype(_impl_.reltol_){}
    , /*decltype(_impl_._cached_size_)*/{}};

  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::memcpy(&_impl_.temp_, &from._impl_.temp_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.reltol_) -
    reinterpret_cast<char*>(&_impl_.temp_)) + sizeof(_impl_.reltol_));
...
// @@protoc_insertion_point(message_clear_start:vlsir.spice.SimOptions)
  ...
  ::memset(&_impl_.temp_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&_impl_.reltol_) -
      reinterpret_cast<char*>(&_impl_.temp_)) + sizeof(_impl_.reltol_));
  _internal_metadata_.Clear<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 17)) {
          _impl_.tnom_ = ::PROTOBUF_NAMESPACE_ID::internal::UnalignedLoad<double>(ptr);
          ptr += sizeof(double);
        } else
          goto handle_unusual;
        continue;
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 25)) {
          _impl_.gmin_ = ::PROTOBUF_NAMESPACE_ID::internal::UnalignedLoad<double>(ptr);
          ptr += sizeof(double);
        } else
          goto handle_unusual;
        continue;
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 33)) {
          _impl_.iabstol_ = ::PROTOBUF_NAMESPACE_ID::internal::UnalignedLoad<double>(ptr);
          ptr += sizeof(double);
        } else
          goto handle_unusual;
        continue;
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 41)) {
          _impl_.reltol_ = ::PROTOBUF_NAMESPACE_ID::internal::UnalignedLoad<double>(ptr);
          ptr += sizeof(double);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* SimOptions::_InternalSerialize(
  ...
  // double tnom = 2;
  static_assert(sizeof(uint64_t) == sizeof(double), "Code assumes uint64_t and double are the same size.");
  double tmp_tnom = this->_internal_tnom();
  uint64_t raw_tnom;
  memcpy(&raw_tnom, &tmp_tnom, sizeof(tmp_tnom));
  if (raw_tnom != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteDoubleToArray(2, this->_internal_tnom(), target);
  }

  // double gmin = 3;
  static_assert(sizeof(uint64_t) == sizeof(double), "Code assumes uint64_t and double are the same size.");
  double tmp_gmin = this->_internal_gmin();
  uint64_t raw_gmin;
  memcpy(&raw_gmin, &tmp_gmin, sizeof(tmp_gmin));
  if (raw_gmin != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteDoubleToArray(3, this->_internal_gmin(), target);
  }

  // double iabstol = 4;
  static_assert(sizeof(uint64_t) == sizeof(double), "Code assumes uint64_t and double are the same size.");
  double tmp_iabstol = this->_internal_iabstol();
  uint64_t raw_iabstol;
  memcpy(&raw_iabstol, &tmp_iabstol, sizeof(tmp_iabstol));
  if (raw_iabstol != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteDoubleToArray(4, this->_internal_iabstol(), target);
  }

  // double reltol = 5;
  static_assert(sizeof(uint64_t) == sizeof(double), "Code assumes uint64_t and double are the same size.");
  double tmp_reltol = this->_internal_reltol();
  uint64_t raw_reltol;
  memcpy(&raw_reltol, &tmp_reltol, sizeof(tmp_reltol));
  if (raw_reltol != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteDoubleToArray(5, this->_internal_reltol(), target);
  }
...
void SimOptions::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  static_assert(sizeof(uint64_t) == sizeof(double), "Code assumes uint64_t and double are the same size.");
  double tmp_tnom = from._internal_tnom();
  uint64_t raw_tnom;
  memcpy(&raw_tnom, &tmp_tnom, sizeof(tmp_tnom));
  if (raw_tnom != 0) {
    _this->_internal_set_tnom(from._internal_tnom());
  }
  static_assert(sizeof(uint64_t) == sizeof(double), "Code assumes uint64_t and double are the same size.");
  double tmp_gmin = from._internal_gmin();
  uint64_t raw_gmin;
  memcpy(&raw_gmin, &tmp_gmin, sizeof(tmp_gmin));
  if (raw_gmin != 0) {
    _this->_internal_set_gmin(from._internal_gmin());
  }
  static_assert(sizeof(uint64_t) == sizeof(double), "Code assumes uint64_t and double are the same size.");
  double tmp_iabstol = from._internal_iabstol();
  uint64_t raw_iabstol;
  memcpy(&raw_iabstol, &tmp_iabstol, sizeof(tmp_iabstol));
  if (raw_iabstol != 0) {
    _this->_internal_set_iabstol(from._internal_iabstol());
  }
  static_assert(sizeof(uint64_t) == sizeof(double), "Code assumes uint64_t and double are the same size.");
  double tmp_reltol = from._internal_reltol();
  uint64_t raw_reltol;
  memcpy(&raw_reltol, &tmp_reltol, sizeof(tmp_reltol));
  if (raw_reltol != 0) {
    _this->_internal_set_reltol(from._internal_reltol());
  }
  _this->_internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}
...
void SimOptions::InternalSwap(SimOptions* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(SimOptions, _impl_.reltol_)
      + sizeof(SimOptions::_impl_.reltol_)
      - PROTOBUF_FIELD_OFFSET(SimOptions, _impl_.temp_)>(
