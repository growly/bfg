...
const char descriptor_table_protodef_utils_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\013utils.proto\022\013vlsir.utils\"z\n\010Prefixed\022%"
  "\n\006prefix\030\001 \001(\0162\025.vlsir.utils.SIPrefix\022\021\n"
  "\007integer\030\002 \001(\003H\000\022\030\n\016floating_point\030\003 \001(\001"
  "H\000\022\020\n\006string\030\004 \001(\tH\000B\010\n\006number\"\222\001\n\nParam"
  "Value\022\021\n\007integer\030\002 \001(\003H\000\022\030\n\016floating_poi"
  "nt\030\003 \001(\001H\000\022\020\n\006string\030\004 \001(\tH\000\022\021\n\007literal\030"
  "\005 \001(\tH\000\022)\n\010prefixed\030\006 \001(\0132\025.vlsir.utils."
  "PrefixedH\000B\007\n\005value\"K\n\005Param\022\014\n\004name\030\001 \001"
  "(\t\022&\n\005value\030\002 \001(\0132\027.vlsir.utils.ParamVal"
  "ue\022\014\n\004desc\030\003 \001(\t\"-\n\rQualifiedName\022\016\n\006dom"
  "ain\030\001 \001(\t\022\014\n\004name\030\002 \001(\t\"R\n\tReference\022\017\n\005"
  "local\030\001 \001(\tH\000\022.\n\010external\030\002 \001(\0132\032.vlsir."
  "utils.QualifiedNameH\000B\004\n\002to\"b\n\017LibraryMe"
  "tadata\022\016\n\006domain\030\001 \001(\t\022\022\n\ncell_names\030\n \003"
  "(\t\022+\n\006author\030\024 \001(\0132\033.vlsir.utils.AuthorM"
...
const ::_pbi::DescriptorTable descriptor_table_utils_2eproto = {
    false, false, 906, descriptor_table_protodef_utils_2eproto,
    "utils.proto",
...
Prefixed::Prefixed(const Prefixed& from)
  ...
  switch (from.number_case()) {
    ...
    case kFloatingPoint: {
      _this->_internal_set_floating_point(from._internal_floating_point());
      break;
    }
    case kString: {
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 25)) {
          _internal_set_floating_point(::PROTOBUF_NAMESPACE_ID::internal::UnalignedLoad<double>(ptr));
          ptr += sizeof(double);
        } else
          goto handle_unusual;
        continue;
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 34)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "vlsir.utils.Prefixed.string"));
        } else
          goto handle_unusual;
        continue;
      default:
...
uint8_t* Prefixed::_InternalSerialize(
  ...
  if (_internal_has_integer()) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteInt64ToArray(2, this->_internal_integer(), target);
  }

  // double floating_point = 3;
  if (_internal_has_floating_point()) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteDoubleToArray(3, this->_internal_floating_point(), target);
  }
    ...
    switch (tag >> 3) {
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 34)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "vlsir.utils.ParamValue.string"));
        } else
          goto handle_unusual;
        continue;
      // string literal = 5;
