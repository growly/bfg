...
class Prefixed final :
 ...
 public:
  ...
  private:
  double _internal_floating_point() const;
  void _internal_set_floating_point(double value);
  public:
...
inline void Prefixed::clear_integer() {
  if (_internal_has_integer()) {
    _impl_.number_.integer_ = int64_t{0};
    clear_has_number();
  }
}
inline int64_t Prefixed::_internal_integer() const {
  if (_internal_has_integer()) {
    return _impl_.number_.integer_;
  }
  return int64_t{0};
}
...
// double floating_point = 3;
inline bool Prefixed::_internal_has_floating_point() const {
  return number_case() == kFloatingPoint;
}
inline bool Prefixed::has_floating_point() const {
  return _internal_has_floating_point();
}
inline void Prefixed::set_has_floating_point() {
  _impl_._oneof_case_[0] = kFloatingPoint;
}
inline void Prefixed::clear_floating_point() {
  if (_internal_has_floating_point()) {
    _impl_.number_.floating_point_ = 0;
    clear_has_number();
  }
}
inline double Prefixed::_internal_floating_point() const {
  if (_internal_has_floating_point()) {
    return _impl_.number_.floating_point_;
  }
  return 0;
}
inline void Prefixed::_internal_set_floating_point(double value) {
  if (!_internal_has_floating_point()) {
    clear_number();
    set_has_floating_point();
  }
  _impl_.number_.floating_point_ = value;
}
inline double Prefixed::floating_point() const {
  // @@protoc_insertion_point(field_get:vlsir.utils.Prefixed.floating_point)
  return _internal_floating_point();
}
inline void Prefixed::set_floating_point(double value) {
  _internal_set_floating_point(value);
  // @@protoc_insertion_point(field_set:vlsir.utils.Prefixed.floating_point)
}
...
inline void Prefixed::clear_string() {
  if (_internal_has_string()) {
    _impl_.number_.string_.Destroy();
    clear_has_number();
  }
}
...
inline void Prefixed::set_string(ArgT0&& arg0, ArgT... args) {
  if (!_internal_has_string()) {
    clear_number();
    set_has_string();
    _impl_.number_.string_.InitDefault();
  }
  _impl_.number_.string_.Set( static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline const std::string& Prefixed::_internal_string() const {
  if (_internal_has_string()) {
    return _impl_.number_.string_.Get();
  }
...
inline void Prefixed::_internal_set_string(const std::string& value) {
  ...
  _impl_.number_.string_.Set(value, GetArenaForAllocation());
}
...
inline void Prefixed::set_allocated_string(std::string* string) {
  ...
  if (string != nullptr) {
    set_has_string();
    _impl_.number_.string_.InitAllocated(string, GetArenaForAllocation());
  }
...
// double floating_point = 3;
inline bool ParamValue::_internal_has_floating_point() const {
  return value_case() == kFloatingPoint;
}
inline bool ParamValue::has_floating_point() const {
  return _internal_has_floating_point();
}
inline void ParamValue::set_has_floating_point() {
  _impl_._oneof_case_[0] = kFloatingPoint;
}
inline void ParamValue::clear_floating_point() {
  if (_internal_has_floating_point()) {
    _impl_.value_.floating_point_ = 0;
    clear_has_value();
  }
}
inline double ParamValue::_internal_floating_point() const {
  if (_internal_has_floating_point()) {
    return _impl_.value_.floating_point_;
  }
  return 0;
}
inline void ParamValue::_internal_set_floating_point(double value) {
  if (!_internal_has_floating_point()) {
    clear_value();
    set_has_floating_point();
  }
  _impl_.value_.floating_point_ = value;
}
inline double ParamValue::floating_point() const {
  // @@protoc_insertion_point(field_get:vlsir.utils.ParamValue.floating_point)
  return _internal_floating_point();
}
inline void ParamValue::set_floating_point(double value) {
  _internal_set_floating_point(value);
  // @@protoc_insertion_point(field_set:vlsir.utils.ParamValue.floating_point)
}
