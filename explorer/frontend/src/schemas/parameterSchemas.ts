...
export const GENERATOR_SCHEMAS: Record<string, GeneratorSchema> = {
  ...
  Sky130InterconnectMux2: {
    name: 'Sky130InterconnectMux2',
    displayName: 'Sky130 Interconnect Mux2',
    description: 'Multiplexer for interconnect routing (variant 2)',
    fields: [
      {
        name: 'num_inputs',
        label: 'Number of Inputs',
  ...
  InterconnectWireBlock: {
    name: 'InterconnectWireBlock',
    displayName: 'Interconnect Wire Block',
    description: 'Wire routing block with channels and bundles for interconnect',
    fields: [
      {
        name: 'direction',
        label: 'Direction',
        type: 'enum',
        enumValues: ['TRACK_HORIZONTAL', 'TRACK_VERTICAL'],
        defaultValue: 'TRACK_VERTICAL',
        description: 'Primary routing direction of the block',
      },
      {
        name: 'grow_down',
        label: 'Grow Down',
        type: 'boolean',
        defaultValue: false,
        description: 'Grow layout downward',
      },
      {
        name: 'grow_left',
        label: 'Grow Left',
        type: 'boolean',
        defaultValue: true,
        description: 'Grow layout leftward',
      },
      {
        name: 'horizontal_layer',
        label: 'Horizontal Layer',
        type: 'string',
        defaultValue: 'met1.drawing',
        description: 'Layer name for horizontal wires',
      },
      {
        name: 'via_layer',
        label: 'Via Layer',
        type: 'string',
        defaultValue: 'via1.drawing',
        description: 'Layer name for vias',
      },
      {
        name: 'vertical_layer',
        label: 'Vertical Layer',
        type: 'string',
        defaultValue: 'met2.drawing',
        description: 'Layer name for vertical wires',
      },
      {
        name: 'horizontal_wire_width_nm',
        label: 'Horizontal Wire Width',
        type: 'number',
        unit: 'nm',
        min: 0,
        step: 10,
        description: 'Width of horizontal wires (optional, uses PDK default if unset)',
      },
      {
        name: 'horizontal_wire_pitch_nm',
        label: 'Horizontal Wire Pitch',
        type: 'number',
        unit: 'nm',
        min: 0,
        step: 10,
        description: 'Pitch of horizontal wires (optional)',
      },
      {
        name: 'horizontal_wire_offset_nm',
        label: 'Horizontal Wire Offset',
        type: 'number',
        unit: 'nm',
        defaultValue: 340,
        min: 0,
        step: 10,
        description: 'Offset for horizontal wires',
      },
      {
        name: 'vertical_wire_width_nm',
        label: 'Vertical Wire Width',
        type: 'number',
        unit: 'nm',
        min: 0,
        step: 10,
        description: 'Width of vertical wires (optional, uses PDK default if unset)',
      },
      {
        name: 'vertical_wire_pitch_nm',
        label: 'Vertical Wire Pitch',
        type: 'number',
        unit: 'nm',
        min: 0,
        step: 10,
        description: 'Pitch of vertical wires (optional)',
      },
      {
        name: 'vertical_wire_offset_nm',
        label: 'Vertical Wire Offset',
        type: 'number',
        unit: 'nm',
        defaultValue: 340,
        min: 0,
        step: 10,
        description: 'Offset for vertical wires',
      },
      {
        name: 'length',
        label: 'Length',
        ...
        min: 0,
        step: 100,
        description: 'Length of the block (height or width depending on direction)',
      },
      {
        name: 'channels',
        label: 'Channels',
        ...
        itemFields: [
          {
            ...
            label: 'Channel Name',
            type: 'string',
            description: 'Name identifier for this channel',
          },
          {
            name: 'break_out',
            label: 'Break Out Indices',
            type: 'string',
            description: 'Comma-separated bundle indices to break out (e.g., "0,3")',
          },
          {
            name: 'num_bundles',
            ...
            min: 1,
            step: 1,
            description: 'Number of wire bundles in this channel',
          },
          {
            name: 'num_wires',
            label: 'Wires per Bundle',
            type: 'number',
            min: 1,
            step: 1,
            description: 'Number of wires in each bundle',
          },
        ],
        description: 'Channel definitions with bundles and break-out points',
      },
    ],
    exampleParams: {
      direction: 'TRACK_VERTICAL',
      grow_down: false,
      grow_left: true,
      horizontal_layer: 'met1.drawing',
      via_layer: 'via1.drawing',
      vertical_layer: 'met2.drawing',
      horizontal_wire_offset_nm: 340,
      vertical_wire_offset_nm: 340,
      length: 30000,
      channels: [
        {
          name: '6X',
