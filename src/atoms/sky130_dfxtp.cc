...
bfg::Layout *Sky130Buf::GenerateLayout() {
  ...
  layout->AddRectangle(Polygon({Point(4530, 1985),
                                Point(4240, 1985),
                                Point(4240, 1940),
                                Point(2960, 1940),
                                Point(2960, 1985),
                                ...
                                Point(4240, 1755),
                                Point(4530, 1755)}));
  layout->AddRectangle(Polygon({Point(4965, 1645),
                                Point(4675, 1645),
                                Point(4675, 1600),
                                Point(2445, 1600),
                                Point(2445, 1645),
  ...
  layout->AddRectangle(Polygon({Point(5710, 2485),
                                Point(1495, 2485),
                                Point(1495, 2065),
                                Point(3395, 2065),
                                Point(3395, 1735),
                                ...
                                Point(4230, 2065),
                                Point(5710, 2065)}));
  layout->AddRectangle(Polygon({Point(5820, 655),
                                Point(5160, 655),
                                Point(5160, 595),
                                Point(4300, 595),
                                Point(4300, 875),
  ...
  layout->AddRectangle(Polygon({Point(6015, 1325),
                                Point(5310, 1325),
                                Point(5310, 2335),
                                Point(4425, 2335),
                                Point(4425, 2165),
                                ...
                                Point(5310, 995),
                                Point(6015, 995)}));
  layout->AddRectangle(Polygon({Point(6935, 1325),
                                Point(6375, 1325),
                                Point(6375, 2465),
                                Point(6035, 2465),
                                Point(6035, 1905),
                                ...
                                Point(6385, 995),
                                Point(6935, 995)}));
  layout->AddRectangle(Polygon({Point(7275, 1575),
                                Point(7215, 1575),
                                Point(7215, 2420),
                                Point(6885, 2420),
                                Point(6885, 1495),
                                ...
                                Point(7225, 740),
                                Point(7275, 740)}));
  layout->AddRectangle(Polygon({Point(4970, 1995),
                                Point(4650, 1995),
                                Point(4650, 1035),
                                Point(4505, 1035),
                                Point(4505, 705),
                                Point(4970, 705)}));
  layout->AddRectangle(Polygon({Point(840, 1965),
                                Point(345, 1965),
                                Point(345, 2465),
                                Point(175, 2465),
                                Point(175, 1795),
                                ...
                                Point(345, 635),
                                Point(840, 635)}));
  layout->AddRectangle(Polygon({Point(7360, 2805),
                                Point(0, 2805),
                                Point(0, 2635),
                                Point(515, 2635),
                                Point(515, 2135),
                                ...
                                Point(6715, 2635),
                                Point(7360, 2635)}));
  layout->AddRectangle(Polygon({Point(7360, 85),
                                Point(6725, 85),
                                Point(6725, 695),
                                Point(6555, 695),
                                Point(6555, 85),
                                ...
                                Point(0, -85),
                                Point(7360, -85)}));
  layout->AddRectangle(Polygon({Point(2210, 535),
                                Point(2045, 535),
                                Point(2045, 805),
                                Point(1990, 805),
                                Point(1990, 1910),
                                ...
                                Point(1875, 365),
                                Point(2210, 365)}));
  layout->AddRectangle(Polygon({Point(3100, 2020),
                                Point(2570, 2020),
                                Point(2570, 955),
                                Point(2215, 955),
                                Point(2215, 735),
                                ...
                                Point(2740, 1655),
                                Point(3100, 1655)}));
  layout->AddRectangle(Polygon({Point(3780, 1575),
                                Point(3440, 1575),
                                Point(3440, 2360),
                                Point(2335, 2360),
                                Point(2335, 2190),
                                ...
                                Point(3610, 1245),
                                Point(3780, 1245)}));
  layout->AddRectangle(Polygon({Point(4355, 535),
                                Point(4120, 535),
                                Point(4120, 2135),
                                Point(4200, 2135),
                                Point(4200, 2465),
  ...
  layout->AddRectangle(Polygon({Point(3540, 1065),
                                Point(3320, 1065),
                                Point(3320, 2615),
                                Point(3170, 2615),
                                Point(3170, 795),
                                ...
                                Point(3455, 795),
                                Point(3540, 795)}));
  layout->AddRectangle(Polygon({Point(2545, 1005),
                                Point(2215, 1005),
                                Point(2215, 735),
                                Point(2315, 735),
                                Point(2315, 105),
                                ...
                                Point(2465, 735),
                                Point(2545, 735)}));
  layout->AddRectangle(Polygon({Point(1905, 2615),
                                Point(1755, 2615),
                                Point(1755, 1665),
                                Point(1430, 1665),
                                Point(1430, 1335),
                                ...
                                Point(1755, 105),
                                Point(1905, 105)}));
  layout->AddRectangle(Polygon({Point(2960, 1365),
                                Point(2445, 1365),
                                Point(2445, 1485),
                                Point(2330, 1485),
                                Point(2330, 2615),
                                ...
                                Point(2810, 105),
                                Point(2960, 105)}));
  layout->AddRectangle(Polygon({Point(2960, 1905),
                                Point(2805, 1905),
                                Point(2805, 2615),
                                Point(2655, 2615),
                                Point(2655, 1575),
                                Point(2960, 1575)}));
  layout->AddRectangle(Polygon({Point(5700, 1905),
                                Point(5445, 1905),
                                Point(5445, 2615),
                                Point(5295, 2615),
                                Point(5295, 1575),
                                ...
                                Point(5560, 1575),
                                Point(5700, 1575)}));
  layout->AddRectangle(Polygon({Point(5050, 1875),
                                Point(4875, 1875),
                                Point(4875, 2615),
                                Point(4725, 2615),
                                Point(4725, 1875),
                                ...
                                Point(4720, 1605),
                                Point(5050, 1605)}));
  layout->AddRectangle(Polygon({Point(965, 2585),
                                Point(815, 2585),
                                Point(815, 1370),
                                Point(590, 1370),
                                Point(590, 1100),
                                ...
                                Point(815, 105),
                                Point(965, 105)}));
  layout->AddRectangle(Polygon({Point(5085, 1395),
                                Point(4510, 1395),
                                Point(4510, 1575),
                                Point(4455, 1575),
                                Point(4455, 2615),
                                ...
                                Point(4935, 105),
                                Point(5085, 105)}));
  layout->AddRectangle(Polygon({Point(545, 880),
                                Point(380, 880),
                                Point(380, 1590),
                                Point(545, 1590),
                                Point(545, 2585),
                                ...
                                Point(395, 105),
                                Point(545, 105)}));
  layout->AddRectangle(Polygon({Point(6985, 1325),
                                Point(6915, 1325),
                                Point(6915, 2615),
                                Point(6765, 2615),
                                Point(6765, 1325),
                                ...
                                Point(6925, 995),
                                Point(6985, 995)}));
  layout->AddRectangle(Polygon({Point(6505, 1325),
                                Point(6495, 1325),
                                Point(6495, 2615),
                                Point(6345, 2615),
                                Point(6345, 1325),
                                ...
                                Point(6355, 105),
                                Point(6505, 105)}));
  layout->AddRectangle(Polygon({Point(4725, 1035),
                                Point(4405, 1035),
                                Point(4405, 105),
                                Point(4555, 105),
                                Point(4555, 705),
                                Point(4725, 705)}));
  layout->AddRectangle(Polygon({Point(4050, 1100),
                                Point(3980, 1100),
                                Point(3980, 2615),
                                Point(3830, 2615),
                                Point(3830, 1545),
  ...
  layout->AddRectangle(Polygon({Point(7360, 1345),
                                Point(5910, 1345),
                                Point(5910, 1925),
                                Point(4675, 1925),
                                Point(4675, 1595),
  ...
  layout->AddRectangle(Polygon({Point(7360, 2910),
                                Point(0, 2910),
                                Point(0, 1685),
                                Point(1350, 1685),
                                Point(1350, 1935),
