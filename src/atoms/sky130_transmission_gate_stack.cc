...
bfg::Cell *Sky130TransmissionGateStack::Generate() {
  ...
  if (pdiff_cover) {
    ...
    // TODO(aryap): This is a function of the transistor type we've selected,
    // and should be generated by the Sky130SimpleTransistor in the
    // Sky130TransmissionGate. This is a kludge.
